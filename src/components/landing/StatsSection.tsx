...
export function StatsSection() {
  ...
  if (loading) {
    return (
      <section className="relative bg-brand-900 py-16 md:py-24 overflow-hidden">
  ...
  return (
    <section ref={statsRef} className="relative bg-brand-900 py-16 md:py-24 overflow-hidden">
      <div className="absolute top-0 left-0 w-72 h-72 rounded-full bg-amber-500/5 blur-[100px]" aria-hidden="true" />
      ...
      <div className="relative mx-auto max-w-7xl px-5 md:px-8">
        {hasData ? (
          ...
          <div className="text-center max-w-lg mx-auto">
            <TrendingUp className="w-10 h-10 text-amber-500/40 mx-auto mb-4" />
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm font-bold text-brand-900 bg-amber-500 hover:bg-amber-600 px-6 py-3 rounded-xl transition-all duration-300 hover:-translate-y-0.5 active:scale-[0.97] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            >
