...
const features: Feature[] = [
  ...
  { icon: Users, section: 'features.payments', href: '/app/tenants' },
  { icon: CreditCard, section: 'features.portal', href: '/app/payments' },
  { icon: FileText, section: 'features.reports', href: '/app/leases' },
  { icon: Bell, section: 'features.ai', href: '/dashboard' },
  { icon: BarChart3, section: 'features.multitenant', href: '/dashboard' },
  { icon: UserCheck, section: 'features.maintenance', href: '/app/tenant' },
  { icon: Shield, section: 'features.documents', href: '/app/settings' },
];
