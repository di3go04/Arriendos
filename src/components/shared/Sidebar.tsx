...
const menuItemDefs = [
  ...
  { key: 'dashboard', icon: LayoutDashboard, href: (role: string) => role === 'arrendador' ? '/dashboard/landlord' : '/dashboard/tenant' },
  ...
  { key: 'contracts', icon: FileText, href: () => '/dashboard/leases' },
  { key: 'payments', icon: DollarSign, href: () => '/dashboard/payments' },
  { key: 'expenses', icon: DollarSign, href: () => '/dashboard/expenses', roles: ['arrendador'] },
  { key: 'reports', icon: FileSpreadsheet, href: () => '/dashboard/reports', roles: ['arrendador'] },
  { key: 'incidents', icon: Wrench, href: () => '/dashboard/maintenance' },
  { key: 'documents', icon: FileCode, href: () => '/dashboard/tenant/documents', roles: ['arrendatario'] },
