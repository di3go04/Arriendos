...
export default function BottomNav() {
  ...
  const mainTabs = isLandlord
    ? [
        { name: t('dashboard'), href: '/dashboard/landlord', icon: LayoutDashboard },
        { name: t('properties'), href: '/properties', icon: Building2 },
        { name: t('collections'), href: '/dashboard/payments', icon: DollarSign },
      ]
    : [
        { name: t('dashboard'), href: '/dashboard/tenant', icon: LayoutDashboard },
        { name: t('my_contract'), href: '/dashboard/leases', icon: FileText },
        { name: t('my_payments'), href: '/dashboard/payments', icon: DollarSign },
      ];

  const moreTabs = isLandlord
    ? [
        { name: t('tenants'), href: '/dashboard/tenants', icon: Users },
        { name: t('templates'), href: '/templates', icon: FileCode },
        { name: t('contracts'), href: '/dashboard/leases', icon: FileText },
        { name: t('incidents'), href: '/dashboard/maintenance', icon: Wrench },
        { name: t('pricing'), href: '/precios', icon: Tag },
        { name: t('settings'), href: '/dashboard/settings', icon: Settings },
      ]
    : [
        { name: t('report_damage'), href: '/dashboard/maintenance', icon: Wrench },
        { name: t('pricing'), href: '/precios', icon: Tag },
        { name: t('settings'), href: '/dashboard/settings', icon: Settings },
      ];
