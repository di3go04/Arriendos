...
const commands: CommandItem[] = [
  { id: '1', label: 'Dashboard', href: '/app/landlord', icon: Home, keywords: ['inicio', 'panel', 'estadisticas'] },
  { id: '2', label: 'Propiedades', href: '/properties', icon: Building2, keywords: ['inmuebles', 'casas', 'apartamentos'] },
  { id: '3', label: 'Contratos', href: '/app/leases', icon: FileText, keywords: ['arriendos', 'rentas', 'leasing'] },
  { id: '4', label: 'Pagos', href: '/app/payments', icon: DollarSign, keywords: ['cobros', 'facturas', 'renta'] },
  { id: '5', label: 'Incidencias', href: '/app/maintenance', icon: Settings, keywords: ['mantenimiento', 'reparaciones'] },
  { id: '6', label: 'Inquilinos', href: '/app/tenants', icon: Users, keywords: ['inquilinos', 'arrendatarios'] },
  { id: '7', label: 'Status del Sistema', href: '/status', icon: ShieldCheck, keywords: ['estado', 'salud', 'monitoreo'] },
  { id: '8', label: 'Configuración', href: '/app/settings', icon: Settings, keywords: ['ajustes', 'perfil', 'preferencias'] },
];
