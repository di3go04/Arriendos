...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  const links = [
    ...
    { href: '/dashboard/properties', icon: Building2, label: tnav('properties') },
    { href: '/dashboard/contracts', icon: FileText, label: tnav('leases') },
    { href: '/dashboard/payments', icon: CreditCard, label: tnav('payments') },
    { href: '/dashboard/verification', icon: Shield, label: tside('verification') },
    { href: '/dashboard/voice-agent', icon: Phone, label: tside('voice_agent') },
    { href: '/dashboard/documents', icon: FileText, label: tside('documents_ia') },
    { href: '/dashboard/affiliates', icon: BarChart3, label: tside('affiliates') },
    { href: '/dashboard/notifications', icon: Bell, label: tside('notifications') },
    { href: '/dashboard/mapa', icon: MapPin, label: tside('mapa') },
    { href: '/dashboard/reports', icon: FileSpreadsheet, label: tside('reports') },
    { href: '/dashboard/subscription', icon: Zap, label: tside('subscription') },
  ]
