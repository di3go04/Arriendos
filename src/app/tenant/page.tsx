...
export const metadata: Metadata = {
  title: 'Portal del Inquilino | RentNow',
};
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 p-6">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-neutral-900 dark:text-white">Mi Portal de Inquilino</h1>
        <p className="text-neutral-500 mt-2">Gestiona tus pagos, contratos y reportes de mantenimiento.</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-neutral-900 p-6 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex flex-col items-center text-center">
          ...
          <h3 className="font-semibold mb-1">Mi Propiedad</h3>
          <p className="text-sm text-neutral-500">Apto 402 - Edificio Centro</p>
        </div>
        ...
        <div className="bg-white dark:bg-neutral-900 p-6 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex flex-col items-center text-center">
          ...
          <h3 className="font-semibold mb-1">Pagos Pendientes</h3>
          <p className="text-xl font-bold mt-1">$450.00 <span className="text-xs font-normal text-danger">Vencido</span></p>
        ...
        <div className="bg-white dark:bg-neutral-900 p-6 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex flex-col items-center text-center">
          ...
          <h3 className="font-semibold mb-1">Contrato Activo</h3>
          <p className="text-sm text-neutral-500">Vence: 12 Nov 2026</p>
          <button className="mt-4 text-primary text-sm hover:underline">Ver PDF</button>
        </div>
        ...
        <div className="bg-white dark:bg-neutral-900 p-6 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex flex-col items-center text-center">
          ...
          <h3 className="font-semibold mb-1">Mantenimiento</h3>
          <p className="text-sm text-neutral-500">0 tickets abiertos</p>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              <tr className="border-b border-neutral-100 dark:border-neutral-800/50">
                ...
                <td className="py-3">Renta Mensual</td>
                <td className="py-3">$450.00</td>
                <td className="py-3"><span className="px-2 py-1 bg-success/10 text-success rounded-full text-xs">Pagado</span></td>
                <td className="py-3 text-right"><button className="text-primary hover:underline">Descargar</button></td>
              </tr>
              <tr>
